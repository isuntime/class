<?php
/* Smarty version 3.1.30, created on 2017-09-26 14:59:02
  from "/home/wwwroot/jiaxiao/public_html/html/default/admin/student/achievement.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59c9fab6cd2de9_54382469',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1bb018a60e78047788951bc210a7489f5537bba3' => 
    array (
      0 => '/home/wwwroot/jiaxiao/public_html/html/default/admin/student/achievement.html',
      1 => 1506409138,
      2 => 'file',
    ),
  ),
...
function content_59c9fab6cd2de9_54382469 (Smarty_Internal_Template $_smarty_tpl) {
?>
<div class="col-sm-8" id="app">
    <div class="regform">
        ...
        <form class="form-inline regform" role="form" action="" method="post" id="studentfind">
            ...
            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal" v-on:click="clearEditApp">录入</button>
        </form>
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="resultinoutform">
                        <table class="table table-bordered table-responsive" class="col-sm-offset-1 col-sm-10">
                            <tr>
                                <td class="col-sm-4">学号</td>
                                <td class="col-sm-6">
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control noempty" id="student_id" name="student_id" placeholder="" v-model="appinfo.student_id">
